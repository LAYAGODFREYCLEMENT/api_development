...
class Product(models.Model):
    class Currency(models.TextChoices):
        ...
        YEN = ("JPY", _("Yen"))
        AUSTRIALIAN_DOLLAR = ("AUD", _("Austrian Dollar"))
        UGANDAN_SHILLINGS = ("Ugx", _("Ugandan Shillings"))
        KENYAN_SHILLINGS = ("Kys", _("Kenyan Shillings"))
    ...
    def __str__(self):
        return f"{self.title}-{self.subtitle} -{self.naker}"
